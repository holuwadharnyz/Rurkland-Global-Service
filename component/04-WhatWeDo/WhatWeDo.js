    ...
    <div className={styles.container}>
      ...
      <div className={styles.col2}>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.wedo_P}>Rurkland specializes in providing high-quality marine/bunker fuels. With a focus on compliance and performance, our fuels ensure optimal efficiency for vessels while meeting international environmental standards. Trust us to power your maritime operations responsibly.</p>
        </div>
